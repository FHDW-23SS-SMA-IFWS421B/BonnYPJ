...
- [1. Systemdokumentation](#1-systemdokumentation)
    ...
    - [1.8 Schnittstellen](#18-schnittstellen)
        - [1.8.1 Translation Bot](#1translation-bot)
      	- [1.8.2 Weather Bot](#2-weather-bot)
        - [1.8.3 Wiki Bot](#3---wiki-bot)
        - [1.8.4 SQL-Datenbank](#4-sql-datenbank)
...
- [2 Bot Dokumentation](#2-bot-dokumentation)
    - [2.1 Übersetzer-Bot](#21-übersetzer-bot)
        ...
        - [2.1.3 Bausteinsicht](#213-bausteinsicht)
    ...
    - [2.2 Wetter-Bot](#22-wetter-bot)
        ...
        - [2.2.3 Bausteinsicht](#223-bausteinsicht)
